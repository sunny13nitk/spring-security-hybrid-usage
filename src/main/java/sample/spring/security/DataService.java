...
/**
 * Simple DataLayer interface that shows how Spring global message security can
 * be used to control access to data objects on a method level.
 */
@Service
public class DataService
{
    ...
    /**
     * Reads sensitive data from the data layer. User requires scope {@code Admin}
     * for this to succeed.
     *
     */
